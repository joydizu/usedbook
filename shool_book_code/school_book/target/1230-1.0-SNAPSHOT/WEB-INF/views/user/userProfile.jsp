	...
	<div class="container"
		...
		<div class="col-md-9" style="float: left">
			...
			<div class="col-md-12 r1"
				style="background-color: #e4e4e4; height: 40px">
				<div class="col-md-6" style="margin-top: 5px">
					<B style="color: #c4c4c4; font-size: 20px">我收藏的书籍</B>
				</div>
			</div>
					...
					<c:choose>
						<c:when test="${collects.size() == 0}">
							<div class="col-md-12" style="margin-top: 50px;" align="center">
								...
								<p style="color: #c4c4c4; font-size: 20px">你还没有收藏书籍哦！</p>
							</div>
						</c:when>
			...
			<div class="col-md-12 r1"
				style="background-color: #e4e4e4; height: 40px">
				<div class="col-md-6" style="margin-top: 5px">
					<B style="color: #c4c4c4; font-size: 20px">我的书籍</B>
				</div>
			</div>
					...
					<c:choose>
						<c:when test="${goods.size() == 0}">
							<div class="col-md-12" style="margin-top: 50px;" align="center">
								...
								<img src="<c:url value="/statics/image/logo/yihan.png"/>"
									width="40%" ; height="222px;">
								<p style="color: #c4c4c4; font-size: 20px">你还没有发布书籍哦！</p>
							</div>
						</c:when>
		...
		<div id="re-bar" class="col-md-3"
			...
			<div class="col-md-12 r2"
								...
								<a target="_blank"
									...
									<div class="col-md-12 rev"
										...
										<div class="col-md-11">
											...
											<p>
												<B style="color: #2aabd2">${review.fromUser}</B>&nbsp;评论了你的书籍
											</p>
										</div>
				...
				<div id="adv-bar" class="col-md-12"
					...
					<div class="col-md-12" align="center">
						<B style="font-size: 16px; color: #c4c4c4">卖出的书籍</B>
					</div>
						...
						<c:choose>
							<c:when test="${sellGoods.size() == 0}">
								<div class="col-md-12" align="center" style="margin-top: 150px">
									<img src="<c:url value="/statics/image/logo/yihan.png"/>"
										width="95%" ; height="170px;">
									<p style="color: #c4c4c4; font-size: 16px">抱歉，暂未卖出书籍！</p>
								</div>
							</c:when>
									...
									<a
										...
										<div class="col-md-12 rev"
											...
											<div class="col-md-11" style="padding: 0px;">
												...
												<p>
													<B style="color: #2aabd2">${sellGood.customer}</B>&nbsp;购买了你的书籍&nbsp;<B
