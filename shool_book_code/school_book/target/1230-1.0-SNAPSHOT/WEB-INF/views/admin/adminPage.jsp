...
<body>
	...
	<div class="container">
		<div class="navbar-header">
			<a class="navbar-brand" style="font-size: 25px">华农校园二手书交易平台后台管理</a>
		</div>
		...
		<div class="col-md-2"
			...
			<div style="float: right; width: 100%;">
				<div id="menu1" onclick="menuBar('menu1')" class="admenu-b"
					align="center">
					<p>
						<B style="font-size: 20px; color: #5c5c5c; cursor: pointer">书籍分类管理</B>
					</p>
				</div>
				...
				<div id="menu2" onclick="menuBar('menu2')" class="admenu"
					align="center">
					<p>
						<B style="font-size: 20px; color: #5c5c5c; cursor: pointer">书籍管理</B>
					</p>
				</div>
							...
							<table class="table" style="margin-bottom: 0px">
								<thead>
									<tr style="color: #666666">
										...
										<th style="width: 10%">书籍ID</th>
										<th style="width: 20%">书籍名称</th>
	...
	<p>
		<a target="_blank"
			href="http://ica1.gdcp.cn/web/loadWebPage.do?1_649_44015038150_3"></a>&nbsp;&nbsp;&nbsp;
	</p>
	</footer>
