	...
	<div class="container"
		...
		<div class="col-md-9">
			<div class="col-md-12 r1"
				...
				<div style="margin-top: 5px">
					<B style="color: #c4c4c4; font-size: 20px;">书籍详细信息</B>
				</div>
			</div>
					...
					<form:form method="post" commandName="good" items="${good}"
						...
						<spring:bind path="name">
							<div class="form-group">
								<form:label path="name" cssClass="control-label">书籍标题</form:label>
						...
						<spring:bind path="prise">
							<div class="form-group">
								<form:label path="prise" cssClass="control-label">书籍价格</form:label>
						...
						<spring:bind path="describe">
							<div class="form-group">
								<form:label path="describe" cssClass="control-label">书籍描述</form:label>
							...
							<c:choose>
								<c:when test="${good.id == 0}">
									<button type="submit" class="btn"
										style="background-color: #e5e5e5">获取书籍ID</button>
								</c:when>
								
								<c:otherwise>
									<button disabled="disabled" type="submit" class="btn"
										style="background-color: #e5e5e5">已获取书籍ID${good.id}</button>
								</c:otherwise>
							</c:choose>
						</div>
					</form:form>
			...
			<div class="col-md-12 r1"
				...
				<div style="margin-top: 5px">
					<B style="color: #c4c4c4; font-size: 20px;">书籍图片信息</B>
				</div>
			</div>
				...
				<div class="col-md-12 r"
					...
					<div class="col-md-12"
						...
						<div class="col-md-12" align="center"
							...
							<h3 style="color: #dcdcdc">请先填写书籍信息，获取书籍ID</h3>
						</div>
					</div>
		...
		<div id="re-bar" class="col-md-3 r"
			...
			<div class="col-md-12 r"
				...
				<B style="font-size: 20px; color: #a2a2a2">最新发布的书籍</B>
			</div>
