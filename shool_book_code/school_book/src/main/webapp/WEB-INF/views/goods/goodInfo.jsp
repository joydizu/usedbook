		...
		<div class="col-md-9">
			<div class="col-md-12 r1"
				...
				<div class="col-md-8" style="margin-top: 5px">
					<B style="color: #c4c4c4; font-size: 20px">书籍信息</B>
				</div>
				...
				<div class="col-md-12" style="margin-top: 40px;">
					...
					<div class="col-md-5">
						...
						<div class="col-md-12" style="margin-top: 50px" align="right">
							<p>
								<a
									href="/wzh-secondshop/goods/userGoods?userId=${goodInfo.userId}">查看卖家其他书籍</a>
							</p>
						</div>
					</div>
				</div>
			...
			<div class="col-md-12 r1"
				...
				<div class="col-md-6" style="margin-top: 5px">
					<B style="color: #c4c4c4; font-size: 20px">书籍描述</B>
				</div>
			</div>
			...
			<div class="col-md-12 r1"
				style="background-color: #e4e4e4; height: 40px; margin-top: 20px;">
				<div class="col-md-6" style="margin-top: 5px">
					<B style="color: #c4c4c4; font-size: 20px">书籍留言</B>
				</div>
			</div>
